...
'</div>' +
    ...
    '<div class="section-card ' + (state.assessmentMode === 'options' ? 'section-green' : 'section-orange') + ' expanded" style="border-left: none; padding: 8px;">' +
        ...
        '<div style="margin-top: 12px;">' +
                ...
                // Assessment Zone (69% in options mode, full width in capture mode)
                '<div style="' + (state.assessmentMode === 'options' ? 'flex: 0 0 69% !important; max-width: 69% !important; min-width: 0;' : '') + '">' +
            ...
            (state.assessmentMode === 'options' ?
                ...
                // Comparison list (29% width on right)
                '<div style="flex: 0 0 29% !important; max-width: 29% !important; min-width: 0;">' +
